...
from functions.dots_ocr.utils.image_utils import smart_resize
from functions.dots_ocr.utils.consts import MIN_PIXELS, MAX_PIXELS
from functions.dots_ocr.utils.output_cleaner import OutputCleaner
