...
from functions.dots_ocr.model.inference import inference_with_vllm
from functions.dots_ocr.utils.consts import image_extensions, MIN_PIXELS, MAX_PIXELS
from functions.dots_ocr.utils.image_utils import get_image_by_fitz_doc, fetch_image, smart_resize
from functions.dots_ocr.utils.doc_utils import fitz_doc_to_image, load_images_from_pdf, load_images_from_pdf_bytes
from functions.dots_ocr.utils.prompts import dict_promptmode_to_prompt
from functions.dots_ocr.utils.layout_utils import post_process_output, draw_layout_on_image, pre_process_bboxes
from functions.dots_ocr.utils.format_transformer import layoutjson2md
...
class DotsOCRParser:
    ...
    def __init__(self, 
            ...
            num_thread=16,
            dpi = 200, 
            output_dir="/home/ubuntu/playground/temp/ocr_output", 
            min_pixels=None,
            max_pixels=None,
            use_hf=False,
        ):
    ...
    def _load_hf_model(self):
        ...
        model_path =Path("/home/ubuntu/playground/models/DotsOCR")
    ...
    def parse_file(self, 
        ...
        md_result = self.process_output(filename=filename, results=results, output_dir=output_dir, save_layout=save_layout)
    ...
    def process_output(self, filename, results, output_dir, save_layout=False):
        layout = []
        ...
        print(output_md)
        return self.read_md(output_md)



def main_ocr(input_file, dots_ocr_parser: DotsOCRParser):
    ...
    #     num_thread=16,
    #     dpi=200,
    #     output_dir='/data1/dataarc/xueqian/playground/temp/ocr_output', 
    #     min_pixels=None,
    #     max_pixels=None,
    #     use_hf=True,
    # )
    ...
    if os.path.isdir(input_file):
        pdf_suffixes = [".pdf"]
        for doc_path in sorted(Path(input_file).glob('*')):
        ...
        return f"Please provide a valid pdf file."
    return results



# if __name__ == "__main__":
#     main_ocr('/data1/dataarc/xueqian/playground/temp/ocr_input/test.pdf')
